...
from . import get_repository_info, get_issues, get_pullrequests
import tempfile
import shutil
import git
import os
...
class Retriever:
    ...
    def start(self):
        functions = [self._get_repository_info, self._get_commits,
                     self._get_issues, self._get_pullrequests]
    ...
    def _get_commits(self):
        ...
        try:
            repo = Git(f"https://github.com/{self._owner}/{self._repository}.git",
