...
urlpatterns = [
    ...
    path('repository/<str:owner>/<str:repository>',
         views.GetSingleRepository.as_view()),
    path('commits/<str:owner>/<str:repository>',
         views.GetRepositoryCommits.as_view()),
    path('issues/<str:owner>/<str:repository>',
         views.GetRepositoryIssues.as_view()),
    path('pullrequests/<str:owner>/<str:repository>',
         views.GetRepositoryPullRequests.as_view()),
    path('metrics/', views.GetRepositoryMetrics.as_view()),
    path('classify/<str:owner>/<str:repository>',
